...
func registerSDKWords(r *eng.Registry, client *sdk.HostedRestSDK) {
...
func runOp(client *sdk.HostedRestSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
