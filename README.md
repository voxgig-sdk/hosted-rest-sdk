...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/hosted-rest` | `npm install @voxgig-sdk/hosted-rest` |
| Python | `voxgig-sdk-hosted-rest` | `pip install voxgig-sdk-hosted-rest` |
| PHP | `voxgig-sdk/hosted-rest` | `composer require voxgig-sdk/hosted-rest` |
| Golang | `github.com/voxgig-sdk/hosted-rest-sdk/go` | `go get github.com/voxgig-sdk/hosted-rest-sdk/go` |
| Ruby | `voxgig-sdk-hosted-rest` | `gem install voxgig-sdk-hosted-rest` |
| Lua | `voxgig-sdk-hosted-rest` | `luarocks install voxgig-sdk-hosted-rest` |
