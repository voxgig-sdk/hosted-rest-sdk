...
OpenAPI specification for the ReqRes API.

Learn more about ReqRes API at [reqres.in](https://reqres.in).
...
This SDK exposes the API as a small set of **semantic entities** — AgentHealth, AgentSandbox, AgentUserDetail, AgentUserList, AppUser, AppUserLogin, AppUserSession, AppUserTotal, AppUserVerify, Authentication, Collection, CollectionRecord, CollectionRecordList, Custom, Legacy, LegacyMutation, LegacyUnknown, LegacyUnknownList, LegacyUser, LegacyUserList, Login and Register — that you
...
| Go CLI | `github.com/voxgig-sdk/hosted-rest-sdk/go-cli` | `go install github.com/voxgig-sdk/hosted-rest-sdk/go-cli/cmd/hosted-rest@latest` |
| Go MCP server | `github.com/voxgig-sdk/hosted-rest-sdk/go-mcp` | `go get github.com/voxgig-sdk/hosted-rest-sdk/go-mcp@latest` |
