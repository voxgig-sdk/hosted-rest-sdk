...
class AgentUserDetailEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AgentUserDetailEntity(self._client, opts)
    ...
    def data_get(self) -> AgentUserDetail:
    ...
    def match_get(self) -> AgentUserDetail:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AgentUserDetail:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AgentUserDetail().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
