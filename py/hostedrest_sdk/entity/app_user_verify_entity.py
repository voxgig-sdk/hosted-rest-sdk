...
class AppUserVerifyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppUserVerifyEntity(self._client, opts)
    ...
    def data_get(self) -> AppUserVerify:
    ...
    def match_get(self) -> AppUserVerify:
    ...
    def create(self, reqdata: AppUserVerifyCreateData, ctrl=None) -> AppUserVerify:
        utility = self._utility
