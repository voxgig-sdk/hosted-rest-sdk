...
class LegacyUnknownListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LegacyUnknownListEntity(self._client, opts)
    ...
    def data_get(self) -> LegacyUnknownList:
    ...
    def match_get(self) -> LegacyUnknownList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[LegacyUnknownList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.LegacyUnknownList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
