...
class AgentHealthEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AgentHealthEntity(self._client, opts)
    ...
    def match_get(self) -> AgentHealth:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AgentHealth:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AgentHealth().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
