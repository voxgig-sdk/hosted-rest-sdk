...
class LegacyUserListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LegacyUserListEntity(self._client, opts)
    ...
    def data_get(self) -> LegacyUserList:
    ...
    def match_get(self) -> LegacyUserList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[LegacyUserList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.LegacyUserList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
