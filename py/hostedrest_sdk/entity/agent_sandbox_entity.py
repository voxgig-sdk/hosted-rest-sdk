...
from hostedrest_sdk.hostedrest_types import (
    AgentSandbox,
...
class AgentSandboxEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AgentSandboxEntity(self._client, opts)
    ...
    def data_get(self) -> AgentSandbox:
    ...
    def match_get(self) -> AgentSandbox:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AgentSandbox:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AgentSandbox().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AgentSandboxCreateData, ctrl=None) -> AgentSandbox:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
