...
class AgentUserListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AgentUserListEntity(self._client, opts)
    ...
    def data_get(self) -> AgentUserList:
    ...
    def match_get(self) -> AgentUserList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AgentUserList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AgentUserList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
