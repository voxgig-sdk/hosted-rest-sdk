...
class CollectionRecordListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CollectionRecordListEntity(self._client, opts)
    ...
    def data_get(self) -> CollectionRecordList:
    ...
    def match_get(self) -> CollectionRecordList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CollectionRecordList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CollectionRecordList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
