...
class RegisterEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegisterEntity(self._client, opts)
    ...
    def create(self, reqdata: RegisterCreateData, ctrl=None) -> Register:
        utility = self._utility
