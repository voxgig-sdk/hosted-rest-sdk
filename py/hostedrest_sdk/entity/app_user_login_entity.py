...
class AppUserLoginEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppUserLoginEntity(self._client, opts)
    ...
    def data_get(self) -> AppUserLogin:
    ...
    def match_get(self) -> AppUserLogin:
    ...
    def create(self, reqdata: AppUserLoginCreateData, ctrl=None) -> AppUserLogin:
        utility = self._utility
