...
class LegacyUnknownEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LegacyUnknownEntity(self._client, opts)
    ...
    def data_get(self) -> LegacyUnknown:
    ...
    def match_get(self) -> LegacyUnknown:
    ...
    def load(self, reqmatch=None, ctrl=None) -> LegacyUnknown:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.LegacyUnknown().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
