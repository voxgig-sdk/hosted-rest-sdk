...
class AppUserTotalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AppUserTotalEntity(self._client, opts)
    ...
    def data_get(self) -> AppUserTotal:
    ...
    def match_get(self) -> AppUserTotal:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AppUserTotal:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AppUserTotal().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
