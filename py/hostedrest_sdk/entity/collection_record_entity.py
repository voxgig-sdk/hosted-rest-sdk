...
class CollectionRecordEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CollectionRecordEntity(self._client, opts)
    ...
    def data_get(self) -> CollectionRecord:
    ...
    def match_get(self) -> CollectionRecord:
    ...
    def create(self, reqdata: CollectionRecordCreateData, ctrl=None) -> CollectionRecord:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: CollectionRecordUpdateData, ctrl=None) -> CollectionRecord:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
