...
from hostedrest_sdk.core.control import HostedRestControl
...
from hostedrest_sdk.core.helpers import get_ctx_prop, to_map
...
class HostedRestContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, HostedRestSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HostedRestResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HostedRestResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return HostedRestError(code, msg, self)
