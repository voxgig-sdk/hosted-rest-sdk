...
class HostedRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HostedRestTestRunner.getenv("HOSTEDREST_TEST_LIVE")
        override = HostedRestTestRunner.getenv("HOSTEDREST_TEST_OVERRIDE")
        ...
        explain = HostedRestTestRunner.getenv("HOSTEDREST_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["HOSTEDREST_TEST_EXPLAIN"] = explain
