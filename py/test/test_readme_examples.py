# HostedRest SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HostedRestSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HostedRestSDK(...) and HostedRestSDK.test(...) become
#      HostedRestSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hostedrest_sdk"
_SDK_CLASS = "HostedRestSDK"
...
_ENTITIES = {
    ...
    "AgentUserDetail": "agent_user_detail",
    "AgentUserList": "agent_user_list",
    "AppUser": "app_user",
    "AppUserLogin": "app_user_login",
    "AppUserSession": "app_user_session",
    "AppUserTotal": "app_user_total",
    "AppUserVerify": "app_user_verify",
    "Authentication": "authentication",
    "Collection": "collection",
    "CollectionRecord": "collection_record",
    "CollectionRecordList": "collection_record_list",
    "Custom": "custom",
    "Legacy": "legacy",
    "LegacyMutation": "legacy_mutation",
    "LegacyUnknown": "legacy_unknown",
    "LegacyUnknownList": "legacy_unknown_list",
    "LegacyUser": "legacy_user",
    "LegacyUserList": "legacy_user_list",
    "Login": "login",
    "Register": "register",
}
