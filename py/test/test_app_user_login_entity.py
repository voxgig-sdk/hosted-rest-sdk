    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set HOSTED_REST_TEST_APP_USER_LOGIN_ENTID JSON to run live")
        client = setup["client"]
        ...
        app_user_login_ref01_data = helpers.to_map(runner.entity_data(app_user_login_ref01_ent.create(app_user_login_ref01_data, None)))
...
def _app_user_login_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "HOSTED_REST_TEST_APP_USER_LOGIN_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("HOSTED_REST_TEST_APP_USER_LOGIN_ENTID"))
