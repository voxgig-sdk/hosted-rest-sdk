...
class AppUserVerifyEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set HOSTEDREST_TEST_APP_USER_VERIFY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def app_user_verify_basic_setup(extra)
  ...
  entid_env_raw = ENV["HOSTEDREST_TEST_APP_USER_VERIFY_ENTID"]
