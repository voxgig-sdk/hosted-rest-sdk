...
class AgentHealthEntity
  ...
  def make
    opts = @_entopts.dup
    AgentHealthEntity.new(@_client, opts)
  end
  ...
  # @return [AgentHealth, Hash] the current AgentHealth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AgentHealth fields)
  def match_get
  ...
  #
  # @param reqmatch [AgentHealthLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AgentHealth.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AgentHealth, Hash] the loaded AgentHealth; raises HostedRestError on failure
