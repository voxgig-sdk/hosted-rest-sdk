...
class LegacyUserEntity
  ...
  def make
    opts = @_entopts.dup
    LegacyUserEntity.new(@_client, opts)
  end
  ...
  # @return [LegacyUser, Hash] the current LegacyUser data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LegacyUser fields)
  def match_get
  ...
  #
  # @param reqmatch [LegacyUserLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.LegacyUser.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [LegacyUser, Hash] the loaded LegacyUser; raises HostedRestError on failure
