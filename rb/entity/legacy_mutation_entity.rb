...
class LegacyMutationEntity
  ...
  def make
    opts = @_entopts.dup
    LegacyMutationEntity.new(@_client, opts)
  end
  ...
  # @return [LegacyMutation, Hash] the current LegacyMutation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LegacyMutation fields)
  def match_get
  ...
  #
  # @param reqdata [LegacyMutationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [LegacyMutation, Hash] the created LegacyMutation; raises HostedRestError on failure
  ...
  #
  # @param reqdata [LegacyMutationUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [LegacyMutation, Hash] the updated LegacyMutation; raises HostedRestError on failure
