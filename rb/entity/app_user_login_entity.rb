...
class AppUserLoginEntity
  ...
  def make
    opts = @_entopts.dup
    AppUserLoginEntity.new(@_client, opts)
  end
  ...
  # @return [AppUserLogin, Hash] the current AppUserLogin data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AppUserLogin fields)
  def match_get
  ...
  #
  # @param reqdata [AppUserLoginCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AppUserLogin, Hash] the created AppUserLogin; raises HostedRestError on failure
