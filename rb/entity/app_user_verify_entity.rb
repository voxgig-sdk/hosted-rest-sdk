...
class AppUserVerifyEntity
  ...
  def make
    opts = @_entopts.dup
    AppUserVerifyEntity.new(@_client, opts)
  end
  ...
  # @return [AppUserVerify, Hash] the current AppUserVerify data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AppUserVerify fields)
  def match_get
  ...
  #
  # @param reqdata [AppUserVerifyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AppUserVerify, Hash] the created AppUserVerify; raises HostedRestError on failure
