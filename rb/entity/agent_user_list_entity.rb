...
class AgentUserListEntity
  ...
  def make
    opts = @_entopts.dup
    AgentUserListEntity.new(@_client, opts)
  end
  ...
  # @return [AgentUserList, Hash] the current AgentUserList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AgentUserList fields)
  def match_get
  ...
  #
  # @param reqmatch [AgentUserListListMatch, Hash, nil] match filter (any subset of
  #   AgentUserList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AgentUserList>, Array] the matching AgentUserList items; raises HostedRestError on failure
