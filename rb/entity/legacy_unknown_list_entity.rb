...
class LegacyUnknownListEntity
  ...
  def make
    opts = @_entopts.dup
    LegacyUnknownListEntity.new(@_client, opts)
  end
  ...
  # @return [LegacyUnknownList, Hash] the current LegacyUnknownList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LegacyUnknownList fields)
  def match_get
  ...
  #
  # @param reqmatch [LegacyUnknownListListMatch, Hash, nil] match filter (any subset of
  #   LegacyUnknownList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LegacyUnknownList>, Array] the matching LegacyUnknownList items; raises HostedRestError on failure
