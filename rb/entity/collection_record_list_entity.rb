...
class CollectionRecordListEntity
  ...
  def make
    opts = @_entopts.dup
    CollectionRecordListEntity.new(@_client, opts)
  end
  ...
  # @return [CollectionRecordList, Hash] the current CollectionRecordList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CollectionRecordList fields)
  def match_get
  ...
  #
  # @param reqmatch [CollectionRecordListListMatch, Hash, nil] match filter (any subset of
  #   CollectionRecordList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CollectionRecordList>, Array] the matching CollectionRecordList items; raises HostedRestError on failure
