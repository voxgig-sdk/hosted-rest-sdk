...
class LegacyUserListEntity
  ...
  def make
    opts = @_entopts.dup
    LegacyUserListEntity.new(@_client, opts)
  end
  ...
  # @return [LegacyUserList, Hash] the current LegacyUserList data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of LegacyUserList fields)
  def match_get
  ...
  #
  # @param reqmatch [LegacyUserListListMatch, Hash, nil] match filter (any subset of
  #   LegacyUserList fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<LegacyUserList>, Array] the matching LegacyUserList items; raises HostedRestError on failure
