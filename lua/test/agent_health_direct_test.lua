...
describe("AgentHealthDirect", function()
  it("should direct-load-agent_health", function()
    local setup = agent_health_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-agent_health", setup.live and "live" or "unit")
...
function agent_health_direct_setup(mockres)
