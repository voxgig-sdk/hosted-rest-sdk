...
function runner.env_override(m)
  local live = runner.getenv("HOSTED_REST_TEST_LIVE")
  local override = runner.getenv("HOSTED_REST_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HOSTED_REST_TEST_EXPLAIN")
