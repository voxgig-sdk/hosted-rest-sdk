...
describe("LegacyUnknownListDirect", function()
  it("should direct-list-legacy_unknown_list", function()
    local setup = legacy_unknown_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-legacy_unknown_list", setup.live and "live" or "unit")
...
function legacy_unknown_list_direct_setup(mockres)
