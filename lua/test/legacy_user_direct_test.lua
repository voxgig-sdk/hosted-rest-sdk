...
describe("LegacyUserDirect", function()
  it("should direct-load-legacy_user", function()
    local setup = legacy_user_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-legacy_user", setup.live and "live" or "unit")
...
function legacy_user_direct_setup(mockres)
