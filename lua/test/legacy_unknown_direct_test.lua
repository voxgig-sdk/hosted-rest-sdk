...
describe("LegacyUnknownDirect", function()
  it("should direct-load-legacy_unknown", function()
    local setup = legacy_unknown_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-legacy_unknown", setup.live and "live" or "unit")
...
function legacy_unknown_direct_setup(mockres)
