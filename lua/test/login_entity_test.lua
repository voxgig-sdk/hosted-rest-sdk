...
describe("LoginEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOSTEDREST_TEST_LOGIN_ENTID JSON to run live")
      return
    end
...
function login_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOSTEDREST_TEST_LOGIN_ENTID")
