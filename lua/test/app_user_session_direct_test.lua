...
describe("AppUserSessionDirect", function()
  it("should direct-load-app_user_session", function()
    local setup = app_user_session_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-app_user_session", setup.live and "live" or "unit")
...
function app_user_session_direct_setup(mockres)
