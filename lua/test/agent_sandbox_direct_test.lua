...
describe("AgentSandboxDirect", function()
  it("should direct-load-agent_sandbox", function()
    local setup = agent_sandbox_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-agent_sandbox", setup.live and "live" or "unit")
...
function agent_sandbox_direct_setup(mockres)
