...
describe("LegacyEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOSTED_REST_TEST_LEGACY_ENTID JSON to run live")
      return
    end
...
function legacy_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOSTED_REST_TEST_LEGACY_ENTID")
