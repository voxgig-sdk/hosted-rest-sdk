...
describe("AgentUserDetailDirect", function()
  it("should direct-load-agent_user_detail", function()
    local setup = agent_user_detail_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-agent_user_detail", setup.live and "live" or "unit")
...
function agent_user_detail_direct_setup(mockres)
