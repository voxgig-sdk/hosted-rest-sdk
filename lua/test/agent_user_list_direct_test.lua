...
describe("AgentUserListDirect", function()
  it("should direct-list-agent_user_list", function()
    local setup = agent_user_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-agent_user_list", setup.live and "live" or "unit")
...
function agent_user_list_direct_setup(mockres)
