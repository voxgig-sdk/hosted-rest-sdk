-- HostedRest SDK AgentHealth entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AgentHealthEntity = {}
AgentHealthEntity.__index = AgentHealthEntity


function AgentHealthEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AgentHealthEntity)
  self._name = "agent_health"
  self._client = client
...
function AgentHealthEntity:get_name()
  return self._name
end


function AgentHealthEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AgentHealthEntity.new(self._client, opts)
end
...
function AgentHealthEntity:mark_deleted()
  self._deleted = true
end


function AgentHealthEntity:deleted()
  return true == self._deleted
end


function AgentHealthEntity:data_set(args)
  if args ~= nil then
...
function AgentHealthEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AgentHealthEntity:match_set(args)
  if args ~= nil then
...
function AgentHealthEntity:match_get()
...
function AgentHealthEntity:stream(action, args, callopts)
...
function AgentHealthEntity:_run_op(ctx, post_done)
  local utility = self._utility
