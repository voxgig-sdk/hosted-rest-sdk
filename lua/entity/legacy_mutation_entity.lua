...
local LegacyMutationEntity = {}
LegacyMutationEntity.__index = LegacyMutationEntity


function LegacyMutationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LegacyMutationEntity)
  self._name = "legacy_mutation"
  self._client = client
...
function LegacyMutationEntity:get_name()
  return self._name
end


function LegacyMutationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LegacyMutationEntity.new(self._client, opts)
end
...
function LegacyMutationEntity:mark_deleted()
  self._deleted = true
end


function LegacyMutationEntity:deleted()
  return true == self._deleted
end


function LegacyMutationEntity:data_set(args)
  if args ~= nil then
...
function LegacyMutationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LegacyMutationEntity:match_set(args)
  if args ~= nil then
...
function LegacyMutationEntity:match_get()
...
function LegacyMutationEntity:stream(action, args, callopts)
...
function LegacyMutationEntity:_run_op(ctx, post_done)
  local utility = self._utility
