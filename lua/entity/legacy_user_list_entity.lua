-- HostedRest SDK LegacyUserList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local LegacyUserListEntity = {}
LegacyUserListEntity.__index = LegacyUserListEntity


function LegacyUserListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LegacyUserListEntity)
  self._name = "legacy_user_list"
  self._client = client
...
function LegacyUserListEntity:get_name()
  return self._name
end


function LegacyUserListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LegacyUserListEntity.new(self._client, opts)
end
...
function LegacyUserListEntity:mark_deleted()
  self._deleted = true
end


function LegacyUserListEntity:deleted()
  return true == self._deleted
end


function LegacyUserListEntity:data_set(args)
  if args ~= nil then
...
function LegacyUserListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LegacyUserListEntity:match_set(args)
  if args ~= nil then
...
function LegacyUserListEntity:match_get()
...
function LegacyUserListEntity:stream(action, args, callopts)
...
function LegacyUserListEntity:_run_op(ctx, post_done)
  local utility = self._utility
