...
local AgentSandboxEntity = {}
AgentSandboxEntity.__index = AgentSandboxEntity


function AgentSandboxEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AgentSandboxEntity)
  self._name = "agent_sandbox"
  self._client = client
...
function AgentSandboxEntity:get_name()
  return self._name
end


function AgentSandboxEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AgentSandboxEntity.new(self._client, opts)
end
...
function AgentSandboxEntity:mark_deleted()
  self._deleted = true
end


function AgentSandboxEntity:deleted()
  return true == self._deleted
end


function AgentSandboxEntity:data_set(args)
  if args ~= nil then
...
function AgentSandboxEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AgentSandboxEntity:match_set(args)
  if args ~= nil then
...
function AgentSandboxEntity:match_get()
...
function AgentSandboxEntity:stream(action, args, callopts)
...
function AgentSandboxEntity:_run_op(ctx, post_done)
  local utility = self._utility
