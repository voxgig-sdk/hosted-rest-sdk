-- HostedRest SDK AppUserVerify entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AppUserVerifyEntity = {}
AppUserVerifyEntity.__index = AppUserVerifyEntity


function AppUserVerifyEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AppUserVerifyEntity)
  self._name = "app_user_verify"
  self._client = client
...
function AppUserVerifyEntity:get_name()
  return self._name
end


function AppUserVerifyEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AppUserVerifyEntity.new(self._client, opts)
end
...
function AppUserVerifyEntity:mark_deleted()
  self._deleted = true
end


function AppUserVerifyEntity:deleted()
  return true == self._deleted
end


function AppUserVerifyEntity:data_set(args)
  if args ~= nil then
...
function AppUserVerifyEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AppUserVerifyEntity:match_set(args)
  if args ~= nil then
...
function AppUserVerifyEntity:match_get()
...
function AppUserVerifyEntity:stream(action, args, callopts)
...
function AppUserVerifyEntity:_run_op(ctx, post_done)
  local utility = self._utility
