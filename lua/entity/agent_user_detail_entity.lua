-- HostedRest SDK AgentUserDetail entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AgentUserDetailEntity = {}
AgentUserDetailEntity.__index = AgentUserDetailEntity


function AgentUserDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AgentUserDetailEntity)
  self._name = "agent_user_detail"
  self._client = client
...
function AgentUserDetailEntity:get_name()
  return self._name
end


function AgentUserDetailEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AgentUserDetailEntity.new(self._client, opts)
end
...
function AgentUserDetailEntity:mark_deleted()
  self._deleted = true
end


function AgentUserDetailEntity:deleted()
  return true == self._deleted
end


function AgentUserDetailEntity:data_set(args)
  if args ~= nil then
...
function AgentUserDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AgentUserDetailEntity:match_set(args)
  if args ~= nil then
...
function AgentUserDetailEntity:match_get()
...
function AgentUserDetailEntity:stream(action, args, callopts)
...
---@param reqmatch AgentUserDetailLoadMatch
---@param ctrl? table
---@return AgentUserDetail
---@return string? err
function AgentUserDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AgentUserDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
