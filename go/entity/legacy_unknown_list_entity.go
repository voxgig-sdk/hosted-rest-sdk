...
type LegacyUnknownListEntity struct {
	name    string
...
func NewLegacyUnknownListEntity(client *core.HostedRestSDK, entopts map[string]any) *LegacyUnknownListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LegacyUnknownListEntity) GetName() string { return e.name }
...
func (e *LegacyUnknownListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LegacyUnknownListEntity) Deleted() bool {
	return e.deleted
}


func (e *LegacyUnknownListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLegacyUnknownListEntity(e.client, opts)
}

func (e *LegacyUnknownListEntity) Data(args ...any) any {
...
func (e *LegacyUnknownListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LegacyUnknownList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LegacyUnknownListEntity) DataTyped(data ...LegacyUnknownList) LegacyUnknownList {
	if len(data) > 0 {
		return typedFrom[LegacyUnknownList](e.Data(asMap(data[0])))
	}
	return typedFrom[LegacyUnknownList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LegacyUnknownList (all fields
// optional at the wire level).
func (e *LegacyUnknownListEntity) MatchTyped(match ...LegacyUnknownList) LegacyUnknownList {
	if len(match) > 0 {
		return typedFrom[LegacyUnknownList](e.Match(asMap(match[0])))
	}
	return typedFrom[LegacyUnknownList](e.Match())
}
...
func (e *LegacyUnknownListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LegacyUnknownListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LegacyUnknownListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LegacyUnknownListListMatch and returns []LegacyUnknownList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LegacyUnknownListEntity) ListTyped(reqmatch LegacyUnknownListListMatch, ctrl map[string]any) ([]LegacyUnknownList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LegacyUnknownList](res), nil
}



func (e *LegacyUnknownListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LegacyUnknownListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LegacyUnknownListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LegacyUnknownListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
