...
type AppUserLoginEntity struct {
	name    string
...
func NewAppUserLoginEntity(client *core.HostedRestSDK, entopts map[string]any) *AppUserLoginEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppUserLoginEntity) GetName() string { return e.name }
...
func (e *AppUserLoginEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AppUserLoginEntity) Deleted() bool {
	return e.deleted
}


func (e *AppUserLoginEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAppUserLoginEntity(e.client, opts)
}

func (e *AppUserLoginEntity) Data(args ...any) any {
...
func (e *AppUserLoginEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AppUserLogin; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AppUserLoginEntity) DataTyped(data ...AppUserLogin) AppUserLogin {
	if len(data) > 0 {
		return typedFrom[AppUserLogin](e.Data(asMap(data[0])))
	}
	return typedFrom[AppUserLogin](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AppUserLogin (all fields
// optional at the wire level).
func (e *AppUserLoginEntity) MatchTyped(match ...AppUserLogin) AppUserLogin {
	if len(match) > 0 {
		return typedFrom[AppUserLogin](e.Match(asMap(match[0])))
	}
	return typedFrom[AppUserLogin](e.Match())
}
...
func (e *AppUserLoginEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AppUserLoginEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AppUserLoginEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AppUserLoginEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AppUserLoginCreateData and returns an AppUserLogin. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AppUserLoginEntity) CreateTyped(reqdata AppUserLoginCreateData, ctrl map[string]any) (AppUserLogin, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return AppUserLogin{}, err
	}
	return typedFrom[AppUserLogin](res), nil
}



func (e *AppUserLoginEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AppUserLoginEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AppUserLoginEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
