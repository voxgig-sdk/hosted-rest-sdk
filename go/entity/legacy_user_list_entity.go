...
func (e *LegacyUserListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LegacyUserListEntity) Deleted() bool {
	return e.deleted
}
...
func (e *LegacyUserListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
