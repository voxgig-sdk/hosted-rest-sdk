...
func (e *AgentHealthEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgentHealthEntity) Deleted() bool {
	return e.deleted
}
...
func (e *AgentHealthEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
