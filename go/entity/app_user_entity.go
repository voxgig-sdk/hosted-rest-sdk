...
func NewAppUserEntity(client *core.HostedRestSDK, entopts map[string]any) *AppUserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppUserEntity) GetName() string { return e.name }
...
func (e *AppUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AppUserEntity) Deleted() bool {
	return e.deleted
}


func (e *AppUserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAppUserEntity(e.client, opts)
}

func (e *AppUserEntity) Data(args ...any) any {
...
func (e *AppUserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *AppUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AppUserEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *AppUserEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *AppUserEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
func (e *AppUserEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *AppUserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
