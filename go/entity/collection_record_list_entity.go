...
type CollectionRecordListEntity struct {
	name    string
...
func NewCollectionRecordListEntity(client *core.HostedRestSDK, entopts map[string]any) *CollectionRecordListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CollectionRecordListEntity) GetName() string { return e.name }
...
func (e *CollectionRecordListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CollectionRecordListEntity) Deleted() bool {
	return e.deleted
}


func (e *CollectionRecordListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCollectionRecordListEntity(e.client, opts)
}

func (e *CollectionRecordListEntity) Data(args ...any) any {
...
func (e *CollectionRecordListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an CollectionRecordList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CollectionRecordListEntity) DataTyped(data ...CollectionRecordList) CollectionRecordList {
	if len(data) > 0 {
		return typedFrom[CollectionRecordList](e.Data(asMap(data[0])))
	}
	return typedFrom[CollectionRecordList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through CollectionRecordList (all fields
// optional at the wire level).
func (e *CollectionRecordListEntity) MatchTyped(match ...CollectionRecordList) CollectionRecordList {
	if len(match) > 0 {
		return typedFrom[CollectionRecordList](e.Match(asMap(match[0])))
	}
	return typedFrom[CollectionRecordList](e.Match())
}
...
func (e *CollectionRecordListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CollectionRecordListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CollectionRecordListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CollectionRecordListListMatch and returns []CollectionRecordList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CollectionRecordListEntity) ListTyped(reqmatch CollectionRecordListListMatch, ctrl map[string]any) ([]CollectionRecordList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[CollectionRecordList](res), nil
}



func (e *CollectionRecordListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CollectionRecordListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CollectionRecordListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CollectionRecordListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
