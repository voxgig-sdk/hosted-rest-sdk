...
type AgentUserListEntity struct {
	name    string
...
func NewAgentUserListEntity(client *core.HostedRestSDK, entopts map[string]any) *AgentUserListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgentUserListEntity) GetName() string { return e.name }
...
func (e *AgentUserListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgentUserListEntity) Deleted() bool {
	return e.deleted
}


func (e *AgentUserListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgentUserListEntity(e.client, opts)
}

func (e *AgentUserListEntity) Data(args ...any) any {
...
func (e *AgentUserListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AgentUserList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AgentUserListEntity) DataTyped(data ...AgentUserList) AgentUserList {
	if len(data) > 0 {
		return typedFrom[AgentUserList](e.Data(asMap(data[0])))
	}
	return typedFrom[AgentUserList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AgentUserList (all fields
// optional at the wire level).
func (e *AgentUserListEntity) MatchTyped(match ...AgentUserList) AgentUserList {
	if len(match) > 0 {
		return typedFrom[AgentUserList](e.Match(asMap(match[0])))
	}
	return typedFrom[AgentUserList](e.Match())
}
...
func (e *AgentUserListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgentUserListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AgentUserListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AgentUserListListMatch and returns []AgentUserList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AgentUserListEntity) ListTyped(reqmatch AgentUserListListMatch, ctrl map[string]any) ([]AgentUserList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AgentUserList](res), nil
}



func (e *AgentUserListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AgentUserListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AgentUserListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AgentUserListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
