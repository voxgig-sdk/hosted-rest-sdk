...
type AppUserTotalEntity struct {
	name    string
...
func NewAppUserTotalEntity(client *core.HostedRestSDK, entopts map[string]any) *AppUserTotalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppUserTotalEntity) GetName() string { return e.name }
...
func (e *AppUserTotalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AppUserTotalEntity) Deleted() bool {
	return e.deleted
}


func (e *AppUserTotalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAppUserTotalEntity(e.client, opts)
}

func (e *AppUserTotalEntity) Data(args ...any) any {
...
func (e *AppUserTotalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AppUserTotal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AppUserTotalEntity) DataTyped(data ...AppUserTotal) AppUserTotal {
	if len(data) > 0 {
		return typedFrom[AppUserTotal](e.Data(asMap(data[0])))
	}
	return typedFrom[AppUserTotal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AppUserTotal (all fields
// optional at the wire level).
func (e *AppUserTotalEntity) MatchTyped(match ...AppUserTotal) AppUserTotal {
	if len(match) > 0 {
		return typedFrom[AppUserTotal](e.Match(asMap(match[0])))
	}
	return typedFrom[AppUserTotal](e.Match())
}
...
func (e *AppUserTotalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AppUserTotalEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AppUserTotalLoadMatch and returns an AppUserTotal. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AppUserTotalEntity) LoadTyped(reqmatch AppUserTotalLoadMatch, ctrl map[string]any) (AppUserTotal, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AppUserTotal{}, err
	}
	return typedFrom[AppUserTotal](res), nil
}



func (e *AppUserTotalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AppUserTotalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AppUserTotalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AppUserTotalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AppUserTotalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
