...
type AppUserVerifyEntity struct {
	name    string
...
func NewAppUserVerifyEntity(client *core.HostedRestSDK, entopts map[string]any) *AppUserVerifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AppUserVerifyEntity) GetName() string { return e.name }
...
func (e *AppUserVerifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AppUserVerifyEntity) Deleted() bool {
	return e.deleted
}


func (e *AppUserVerifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAppUserVerifyEntity(e.client, opts)
}

func (e *AppUserVerifyEntity) Data(args ...any) any {
...
func (e *AppUserVerifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AppUserVerify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AppUserVerifyEntity) DataTyped(data ...AppUserVerify) AppUserVerify {
	if len(data) > 0 {
		return typedFrom[AppUserVerify](e.Data(asMap(data[0])))
	}
	return typedFrom[AppUserVerify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AppUserVerify (all fields
// optional at the wire level).
func (e *AppUserVerifyEntity) MatchTyped(match ...AppUserVerify) AppUserVerify {
	if len(match) > 0 {
		return typedFrom[AppUserVerify](e.Match(asMap(match[0])))
	}
	return typedFrom[AppUserVerify](e.Match())
}
...
func (e *AppUserVerifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AppUserVerifyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AppUserVerifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *AppUserVerifyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AppUserVerifyCreateData and returns an AppUserVerify. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AppUserVerifyEntity) CreateTyped(reqdata AppUserVerifyCreateData, ctrl map[string]any) (AppUserVerify, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return AppUserVerify{}, err
	}
	return typedFrom[AppUserVerify](res), nil
}



func (e *AppUserVerifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AppUserVerifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AppUserVerifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
