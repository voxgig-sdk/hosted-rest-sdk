...
func NewLegacyUserEntity(client *core.HostedRestSDK, entopts map[string]any) *LegacyUserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LegacyUserEntity) GetName() string { return e.name }
...
func (e *LegacyUserEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LegacyUserEntity) Deleted() bool {
	return e.deleted
}


func (e *LegacyUserEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLegacyUserEntity(e.client, opts)
}

func (e *LegacyUserEntity) Data(args ...any) any {
...
func (e *LegacyUserEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LegacyUser; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LegacyUserEntity) DataTyped(data ...LegacyUser) LegacyUser {
	if len(data) > 0 {
		return typedFrom[LegacyUser](e.Data(asMap(data[0])))
	}
	return typedFrom[LegacyUser](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LegacyUser (all fields
// optional at the wire level).
func (e *LegacyUserEntity) MatchTyped(match ...LegacyUser) LegacyUser {
	if len(match) > 0 {
		return typedFrom[LegacyUser](e.Match(asMap(match[0])))
	}
	return typedFrom[LegacyUser](e.Match())
}
...
func (e *LegacyUserEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LegacyUserEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LegacyUserLoadMatch and returns an LegacyUser. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LegacyUserEntity) LoadTyped(reqmatch LegacyUserLoadMatch, ctrl map[string]any) (LegacyUser, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LegacyUser{}, err
	}
	return typedFrom[LegacyUser](res), nil
}



func (e *LegacyUserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LegacyUserEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LegacyUserEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LegacyUserEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LegacyUserEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
