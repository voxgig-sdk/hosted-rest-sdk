...
type LegacyUnknownEntity struct {
	name    string
...
func NewLegacyUnknownEntity(client *core.HostedRestSDK, entopts map[string]any) *LegacyUnknownEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LegacyUnknownEntity) GetName() string { return e.name }
...
func (e *LegacyUnknownEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LegacyUnknownEntity) Deleted() bool {
	return e.deleted
}


func (e *LegacyUnknownEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLegacyUnknownEntity(e.client, opts)
}

func (e *LegacyUnknownEntity) Data(args ...any) any {
...
func (e *LegacyUnknownEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LegacyUnknown; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LegacyUnknownEntity) DataTyped(data ...LegacyUnknown) LegacyUnknown {
	if len(data) > 0 {
		return typedFrom[LegacyUnknown](e.Data(asMap(data[0])))
	}
	return typedFrom[LegacyUnknown](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LegacyUnknown (all fields
// optional at the wire level).
func (e *LegacyUnknownEntity) MatchTyped(match ...LegacyUnknown) LegacyUnknown {
	if len(match) > 0 {
		return typedFrom[LegacyUnknown](e.Match(asMap(match[0])))
	}
	return typedFrom[LegacyUnknown](e.Match())
}
...
func (e *LegacyUnknownEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LegacyUnknownEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LegacyUnknownLoadMatch and returns an LegacyUnknown. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LegacyUnknownEntity) LoadTyped(reqmatch LegacyUnknownLoadMatch, ctrl map[string]any) (LegacyUnknown, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LegacyUnknown{}, err
	}
	return typedFrom[LegacyUnknown](res), nil
}



func (e *LegacyUnknownEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LegacyUnknownEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LegacyUnknownEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LegacyUnknownEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LegacyUnknownEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
