...
func (e *AgentSandboxEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgentSandboxEntity) Deleted() bool {
	return e.deleted
}
...
func (e *AgentSandboxEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
