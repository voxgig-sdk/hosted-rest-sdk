...
func NewRegisterEntity(client *core.HostedRestSDK, entopts map[string]any) *RegisterEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegisterEntity) GetName() string { return e.name }
...
func (e *RegisterEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegisterEntity) Deleted() bool {
	return e.deleted
}


func (e *RegisterEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegisterEntity(e.client, opts)
}

func (e *RegisterEntity) Data(args ...any) any {
...
func (e *RegisterEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Register; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RegisterEntity) DataTyped(data ...Register) Register {
	if len(data) > 0 {
		return typedFrom[Register](e.Data(asMap(data[0])))
	}
	return typedFrom[Register](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Register (all fields
// optional at the wire level).
func (e *RegisterEntity) MatchTyped(match ...Register) Register {
	if len(match) > 0 {
		return typedFrom[Register](e.Match(asMap(match[0])))
	}
	return typedFrom[Register](e.Match())
}
...
func (e *RegisterEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegisterEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RegisterEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RegisterEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RegisterCreateData and returns an Register. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *RegisterEntity) CreateTyped(reqdata RegisterCreateData, ctrl map[string]any) (Register, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Register{}, err
	}
	return typedFrom[Register](res), nil
}



func (e *RegisterEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegisterEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegisterEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
