...
type AgentUserDetailEntity struct {
	name    string
...
func NewAgentUserDetailEntity(client *core.HostedRestSDK, entopts map[string]any) *AgentUserDetailEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgentUserDetailEntity) GetName() string { return e.name }
...
func (e *AgentUserDetailEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgentUserDetailEntity) Deleted() bool {
	return e.deleted
}


func (e *AgentUserDetailEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgentUserDetailEntity(e.client, opts)
}

func (e *AgentUserDetailEntity) Data(args ...any) any {
...
func (e *AgentUserDetailEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AgentUserDetail; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AgentUserDetailEntity) DataTyped(data ...AgentUserDetail) AgentUserDetail {
	if len(data) > 0 {
		return typedFrom[AgentUserDetail](e.Data(asMap(data[0])))
	}
	return typedFrom[AgentUserDetail](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AgentUserDetail (all fields
// optional at the wire level).
func (e *AgentUserDetailEntity) MatchTyped(match ...AgentUserDetail) AgentUserDetail {
	if len(match) > 0 {
		return typedFrom[AgentUserDetail](e.Match(asMap(match[0])))
	}
	return typedFrom[AgentUserDetail](e.Match())
}
...
func (e *AgentUserDetailEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgentUserDetailEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AgentUserDetailLoadMatch and returns an AgentUserDetail. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AgentUserDetailEntity) LoadTyped(reqmatch AgentUserDetailLoadMatch, ctrl map[string]any) (AgentUserDetail, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return AgentUserDetail{}, err
	}
	return typedFrom[AgentUserDetail](res), nil
}



func (e *AgentUserDetailEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AgentUserDetailEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AgentUserDetailEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AgentUserDetailEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AgentUserDetailEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
