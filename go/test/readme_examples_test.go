...
const testSeed = `map[string]any{"entity": map[string]any{"agent_health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agent_sandbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agent_user_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "agent_user_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "app_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "app_user_login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "app_user_session": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "app_user_total": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "app_user_verify": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "authentication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection_record": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "collection_record_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy_mutation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy_unknown": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy_unknown_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy_user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "legacy_user_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "register": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
