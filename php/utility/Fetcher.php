...
// HostedRest SDK utility: fetcher

class HostedRestFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HostedRestSDK/1.0)';
    ...
    public static function call(HostedRestContext $ctx, string $fullurl, array $fetchdef): array
    {
