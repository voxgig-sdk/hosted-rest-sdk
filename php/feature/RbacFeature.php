...
class HostedRestRbacFeature extends HostedRestBaseFeature
{
    ...
    private function _required(HostedRestContext $ctx): ?string
    {
    ...
    private function _reject(HostedRestContext $ctx, string $required): void
    {
    ...
    private function _track(HostedRestContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
