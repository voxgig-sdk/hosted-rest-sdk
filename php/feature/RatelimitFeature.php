...
// HostedRest SDK ratelimit feature
...
class HostedRestRatelimitFeature extends HostedRestBaseFeature
{
    ...
    private function _acquire(HostedRestContext $ctx): void
    {
    ...
    private function _track(HostedRestContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
