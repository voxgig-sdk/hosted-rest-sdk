...
// HostedRest SDK idempotency feature
...
class HostedRestIdempotencyFeature extends HostedRestBaseFeature
{
    ...
    private function _mutating(HostedRestContext $ctx): bool
    {
