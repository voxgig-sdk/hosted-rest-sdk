...
class HostedRestProxyFeature extends HostedRestBaseFeature
{
    ...
    public function init(HostedRestContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HostedRestContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
