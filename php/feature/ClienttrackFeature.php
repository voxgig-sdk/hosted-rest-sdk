...
// HostedRest SDK clienttrack feature
...
class HostedRestClienttrackFeature extends HostedRestBaseFeature
{
    ...
    public function PostConstruct(HostedRestContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HostedRest-SDK';
