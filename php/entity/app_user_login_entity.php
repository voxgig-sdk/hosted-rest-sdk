...
class AppUserLoginEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AppUserLoginEntity($this->_client, $opts);
    }

    /**
     * @param AppUserLogin|array $args AppUserLogin data (assoc-array) to store.
     */
    ...
    /**
     * @return AppUserLogin|array The current AppUserLogin data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AppUserLogin fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AppUserLogin fields).
     */
    ...
    /**
     * Create a new AppUserLogin.
     *
     * @param AppUserLoginCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AppUserLoginCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AppUserLogin|array The created AppUserLogin as an assoc-array at the
