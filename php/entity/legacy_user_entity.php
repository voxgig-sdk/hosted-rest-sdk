...
class LegacyUserEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LegacyUserEntity($this->_client, $opts);
    }

    /**
     * @param LegacyUser|array $args LegacyUser data (assoc-array) to store.
     */
    ...
    /**
     * @return LegacyUser|array The current LegacyUser data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LegacyUser fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LegacyUser fields).
     */
    ...
    /**
     * Load a single LegacyUser.
     *
     * @param LegacyUserLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LegacyUserLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyUser|array The loaded LegacyUser as an assoc-array at the
