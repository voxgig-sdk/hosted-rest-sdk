...
class LegacyUserListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LegacyUserListEntity($this->_client, $opts);
    }

    /**
     * @param LegacyUserList|array $args LegacyUserList data (assoc-array) to store.
     */
    ...
    /**
     * @return LegacyUserList|array The current LegacyUserList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LegacyUserList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LegacyUserList fields).
     */
    ...
    /**
     * List LegacyUserList items matching the given filter.
     *
     * @param LegacyUserListListMatch|array|null $reqmatch Match filter (any subset
     *   of LegacyUserList fields) as an assoc-array; LegacyUserListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyUserList[]|array A list of LegacyUserList items as assoc-arrays at
