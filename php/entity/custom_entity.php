...
class CustomEntity
{
     ...
     * Create a new Custom.
     *
     * @param CustomCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Custom|array The created Custom as an assoc-array at the
     *   SDK boundary; throws HostedRestError on failure (item-5 convention).
     */
     ...
     *
     * @param CustomRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CustomRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Custom|array The removed Custom as an assoc-array at the
     *   SDK boundary; throws HostedRestError on failure (item-5 convention).
     */
