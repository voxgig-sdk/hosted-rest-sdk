...
class AppUserSessionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AppUserSessionEntity($this->_client, $opts);
    }

    /**
     * @param AppUserSession|array $args AppUserSession data (assoc-array) to store.
     */
    ...
    /**
     * @return AppUserSession|array The current AppUserSession data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AppUserSession fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AppUserSession fields).
     */
    ...
    /**
     * Load a single AppUserSession.
     *
     * @param AppUserSessionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AppUserSessionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AppUserSession|array The loaded AppUserSession as an assoc-array at the
