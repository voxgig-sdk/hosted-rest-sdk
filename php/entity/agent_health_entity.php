...
class AgentHealthEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentHealthEntity($this->_client, $opts);
    }

    /**
     * @param AgentHealth|array $args AgentHealth data (assoc-array) to store.
     */
    ...
    /**
     * @return AgentHealth|array The current AgentHealth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AgentHealth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AgentHealth fields).
     */
    ...
    /**
     * Load a single AgentHealth.
     *
     * @param AgentHealthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgentHealthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentHealth|array The loaded AgentHealth as an assoc-array at the
