...
class AgentUserDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentUserDetailEntity($this->_client, $opts);
    }

    /**
     * @param AgentUserDetail|array $args AgentUserDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return AgentUserDetail|array The current AgentUserDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AgentUserDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AgentUserDetail fields).
     */
    ...
    /**
     * Load a single AgentUserDetail.
     *
     * @param AgentUserDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgentUserDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentUserDetail|array The loaded AgentUserDetail as an assoc-array at the
