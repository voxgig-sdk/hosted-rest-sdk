...
// HostedRest SDK AgentSandbox entity
...
class AgentSandboxEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentSandboxEntity($this->_client, $opts);
    }

    /**
     * @param AgentSandbox|array $args AgentSandbox data (assoc-array) to store.
     */
    ...
    /**
     * @return AgentSandbox|array The current AgentSandbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AgentSandbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AgentSandbox fields).
     */
    ...
    /**
     * Load a single AgentSandbox.
     *
     * @param AgentSandboxLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgentSandboxLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentSandbox|array The loaded AgentSandbox as an assoc-array at the
    ...
    /**
     * Create a new AgentSandbox.
     *
     * @param AgentSandboxCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AgentSandboxCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentSandbox|array The created AgentSandbox as an assoc-array at the
     *   SDK boundary; throws HostedRestError on failure (item-5 convention).
     */
