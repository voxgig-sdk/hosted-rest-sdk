...
class AgentUserListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AgentUserListEntity($this->_client, $opts);
    }

    /**
     * @param AgentUserList|array $args AgentUserList data (assoc-array) to store.
     */
    ...
    /**
     * @return AgentUserList|array The current AgentUserList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AgentUserList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AgentUserList fields).
     */
    ...
    /**
     * List AgentUserList items matching the given filter.
     *
     * @param AgentUserListListMatch|array|null $reqmatch Match filter (any subset
     *   of AgentUserList fields) as an assoc-array; AgentUserListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AgentUserList[]|array A list of AgentUserList items as assoc-arrays at
