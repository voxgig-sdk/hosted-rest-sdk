...
class RegisterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RegisterEntity($this->_client, $opts);
    }

    /**
     * @param Register|array $args Register data (assoc-array) to store.
     */
    ...
    /**
     * @return Register|array The current Register data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Register fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Register fields).
     */
     ...
     *
     * @param RegisterCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RegisterCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Register|array The created Register as an assoc-array at the
