...
class AppUserTotalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AppUserTotalEntity($this->_client, $opts);
    }

    /**
     * @param AppUserTotal|array $args AppUserTotal data (assoc-array) to store.
     */
    ...
    /**
     * @return AppUserTotal|array The current AppUserTotal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AppUserTotal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AppUserTotal fields).
     */
     ...
     *
     * @param AppUserTotalLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AppUserTotalLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AppUserTotal|array The loaded AppUserTotal as an assoc-array at the
