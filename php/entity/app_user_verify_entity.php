...
class AppUserVerifyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AppUserVerifyEntity($this->_client, $opts);
    }

    /**
     * @param AppUserVerify|array $args AppUserVerify data (assoc-array) to store.
     */
    ...
    /**
     * @return AppUserVerify|array The current AppUserVerify data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AppUserVerify fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AppUserVerify fields).
     */
    ...
    /**
     * Create a new AppUserVerify.
     *
     * @param AppUserVerifyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AppUserVerifyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AppUserVerify|array The created AppUserVerify as an assoc-array at the
