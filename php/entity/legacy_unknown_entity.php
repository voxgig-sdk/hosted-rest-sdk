...
class LegacyUnknownEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LegacyUnknownEntity($this->_client, $opts);
    }

    /**
     * @param LegacyUnknown|array $args LegacyUnknown data (assoc-array) to store.
     */
    ...
    /**
     * @return LegacyUnknown|array The current LegacyUnknown data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LegacyUnknown fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LegacyUnknown fields).
     */
    ...
    /**
     * Load a single LegacyUnknown.
     *
     * @param LegacyUnknownLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LegacyUnknownLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyUnknown|array The loaded LegacyUnknown as an assoc-array at the
