...
class LegacyMutationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LegacyMutationEntity($this->_client, $opts);
    }

    /**
     * @param LegacyMutation|array $args LegacyMutation data (assoc-array) to store.
     */
    ...
    /**
     * @return LegacyMutation|array The current LegacyMutation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LegacyMutation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LegacyMutation fields).
     */
    ...
    /**
     * Create a new LegacyMutation.
     *
     * @param LegacyMutationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LegacyMutationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyMutation|array The created LegacyMutation as an assoc-array at the
    ...
    /**
     * Update an existing LegacyMutation.
     *
     * @param LegacyMutationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LegacyMutationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LegacyMutation|array The updated LegacyMutation as an assoc-array at the
     *   SDK boundary; throws HostedRestError on failure (item-5 convention).
     */
