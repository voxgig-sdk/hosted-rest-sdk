...
class AgentSandboxEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HOSTEDREST_TEST_AGENT_SANDBOX_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function agent_sandbox_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HOSTEDREST_TEST_AGENT_SANDBOX_ENTID");
