...
// HostedRest SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HostedRestSDK::test)
...
{
    private const SDK_CLASS = 'HostedRestSDK';
    ...
    private const SDK_BASE = 'hostedrest_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hostedrest_sdk.php';
