...
class AgentUserDetailDirectTest extends TestCase
{
    public function test_direct_load_agent_user_detail(): void
    {
        $setup = agent_user_detail_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-agent_user_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
