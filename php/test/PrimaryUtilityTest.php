...
// HostedRest SDK primary utility test
...
class PrimaryUtilityTest extends TestCase
{
    ...
    private static function make_ctx_from_map(
        ?array $ctxmap,
        HostedRestSDK $client,
        HostedRestUtility $utility
    ): HostedRestContext {
        if ($ctxmap === null) {
            $ctxmap = [];
        }

        $ctx = new HostedRestContext($ctxmap, null);
    ...
    private static function fixctx(HostedRestContext $ctx, HostedRestSDK $client): void
    {
    ...
    private static function err_from_map(?array $m): ?HostedRestError
    {
        if ($m === null) {
            return null;
        }
        ...
        $code = $m['code'] ?? '';
        return new HostedRestError($code, $msg);
    }
    ...
    public function test_make_error_no_throw(): void
    {
        ...
        $ctx->result = new HostedRestResult([
            'ok' => false,
            'resdata' => ['id' => 'safe01'],
        ]);
    ...
    public function test_feature_add_basic(): void
    {
        ...
        $feature = new HostedRestBaseFeature();
    ...
    {
        $hook_client = HostedRestSDK::test(null, null);
        $hook_utility = $hook_client->get_utility();
        $ctx = self::make_test_ctx($hook_client, $hook_utility);

        $called = false;
        $hook_feature = new class extends HostedRestBaseFeature {
            public $hook_fn = null;
            public function TestHook(HostedRestContext $ctx): void
            {
    ...
    {
        $init_client = HostedRestSDK::test(null, null);
        ...
        $init_called = false;
        $feature = new class extends HostedRestBaseFeature {
            public $init_fn = null;
    ...
    {
        $blocked_client = new HostedRestSDK([
            'system' => [
    ...
    public function test_make_result_no_result(): void
    {
        ...
        $utility = $client->get_utility();
        $ctx = self::make_test_full_ctx($client, $utility);
        $ctx->spec = new HostedRestSpec(['step' => 'start']);
        $ctx->result = null;
    ...
    public function test_make_spec_basic(): void
    {
        ...
        $spec_client = HostedRestSDK::test(null, $setup_opts);
    ...
    public function test_prepare_auth_basic(): void
    {
        ...
        $auth_client = HostedRestSDK::test(null, $setup_opts);
    ...
    public function test_result_basic_basic(): void
    {
        ...
        $this->runset(self::get_spec($primary, 'resultBasic', 'basic'), function (array $entry) use ($client, $utility) {
            ...
            if ($result->err !== null) {
                $err_msg = ($result->err instanceof HostedRestError) ? $result->err->msg : (string)$result->err;
