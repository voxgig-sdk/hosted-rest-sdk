...
class LegacyUserDirectTest extends TestCase
{
    public function test_direct_load_legacy_user(): void
    {
        $setup = legacy_user_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-legacy_user", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
