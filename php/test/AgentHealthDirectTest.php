...
class AgentHealthDirectTest extends TestCase
{
    public function test_direct_load_agent_health(): void
    {
        $setup = agent_health_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-agent_health", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
