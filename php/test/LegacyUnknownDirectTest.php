...
class LegacyUnknownDirectTest extends TestCase
{
    public function test_direct_load_legacy_unknown(): void
    {
        $setup = legacy_unknown_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-legacy_unknown", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
