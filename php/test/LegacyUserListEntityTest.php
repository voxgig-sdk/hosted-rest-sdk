...
class LegacyUserListEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HOSTED_REST_TEST_LEGACY_USER_LIST_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function legacy_user_list_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HOSTED_REST_TEST_LEGACY_USER_LIST_ENTID");
