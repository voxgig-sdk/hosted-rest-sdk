...
class AppUserSessionEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HOSTEDREST_TEST_APP_USER_SESSION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function app_user_session_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HOSTEDREST_TEST_APP_USER_SESSION_ENTID");
