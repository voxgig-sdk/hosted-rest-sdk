...
class CollectionRecordDirectTest extends TestCase
{
    public function test_direct_load_collection_record(): void
    {
        $setup = collection_record_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-collection_record", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
