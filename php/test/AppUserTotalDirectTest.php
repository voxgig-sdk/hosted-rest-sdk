...
class AppUserTotalDirectTest extends TestCase
{
    public function test_direct_load_app_user_total(): void
    {
        $setup = app_user_total_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-app_user_total", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
