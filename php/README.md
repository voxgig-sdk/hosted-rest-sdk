...
The PHP SDK for the HostedRest API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->AgentHealth(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->HostedRest(null)->load(
    ["id" => "test01"], null
);
