...
class AppUserSessionEntity extends HostedRestEntityBase<AppUserSession> {
  ...
  constructor(client: HostedRestSDK, entopts: any) {
    ...
    this.name = 'app_user_session'
    this.name_ = 'app_user_session'
    this.Name = 'AppUserSession'
  }


  make(this: AppUserSessionEntity) {
    return new AppUserSessionEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AppUserSessionLoadMatch, ctrl?: Control): Promise<AppUserSessionEntity> {
