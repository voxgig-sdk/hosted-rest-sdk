...
class CustomEntity extends HostedRestEntityBase<Custom> {
  ...
  async create(this: any, reqdata?: CustomCreateData, ctrl?: Control): Promise<CustomEntity> {
  ...
  async remove(
    this: any, reqmatch?: CustomRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<CustomEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
