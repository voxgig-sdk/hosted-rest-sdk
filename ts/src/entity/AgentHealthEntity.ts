...
class AgentHealthEntity extends HostedRestEntityBase<AgentHealth> {
  ...
  constructor(client: HostedRestSDK, entopts: any) {
    ...
    this.name = 'agent_health'
    this.name_ = 'agent_health'
    this.Name = 'AgentHealth'
  }


  make(this: AgentHealthEntity) {
    return new AgentHealthEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AgentHealthLoadMatch, ctrl?: Control): Promise<AgentHealthEntity> {
