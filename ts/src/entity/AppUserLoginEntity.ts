...
class AppUserLoginEntity extends HostedRestEntityBase<AppUserLogin> {
  ...
  constructor(client: HostedRestSDK, entopts: any) {
    ...
    this.name = 'app_user_login'
    this.name_ = 'app_user_login'
    this.Name = 'AppUserLogin'
  }


  make(this: AppUserLoginEntity) {
    return new AppUserLoginEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: AppUserLoginCreateData, ctrl?: Control): Promise<AppUserLoginEntity> {
