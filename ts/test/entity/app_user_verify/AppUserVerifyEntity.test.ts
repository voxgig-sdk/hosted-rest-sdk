...
describe('AppUserVerifyEntity', async () => {
  ...
  test('instance', async () => {
    ...
    const ent = testsdk.AppUserVerify()
    assert(null != ent)
  })
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['create']) {
      if (maybeSkipControl(t, 'entityOp', 'app_user_verify.' + op, live)) return
    }
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/app_user_verify/AppUserVerifyTestData.json')
  ...
  const idmapEnvVal = process.env['HOSTED_REST_TEST_APP_USER_VERIFY_ENTID']
  ...
  idmap = env['HOSTED_REST_TEST_APP_USER_VERIFY_ENTID']
