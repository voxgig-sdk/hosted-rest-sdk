...
describe('AppUserTotalDirect', async () => {
  ...
  test('direct-load-app_user_total', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-app_user_total', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_APP_USER_TOTAL_ENTID']
