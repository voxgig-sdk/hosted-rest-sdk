...
describe('AgentUserDetailDirect', async () => {
  ...
  test('direct-load-agent_user_detail', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-agent_user_detail', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_AGENT_USER_DETAIL_ENTID']
