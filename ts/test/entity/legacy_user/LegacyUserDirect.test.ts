...
describe('LegacyUserDirect', async () => {
  ...
  test('direct-load-legacy_user', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-legacy_user', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_LEGACY_USER_ENTID']
