...
describe('AppUserSessionDirect', async () => {
  ...
  test('direct-load-app_user_session', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-app_user_session', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_APP_USER_SESSION_ENTID']
