...
describe('AgentSandboxDirect', async () => {
  ...
  test('direct-load-agent_sandbox', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-agent_sandbox', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_AGENT_SANDBOX_ENTID']
