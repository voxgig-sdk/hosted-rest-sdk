...
describe('LegacyUserListDirect', async () => {
  ...
  test('direct-list-legacy_user_list', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-legacy_user_list', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_LEGACY_USER_LIST_ENTID']
