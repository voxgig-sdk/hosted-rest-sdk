...
describe('LegacyUnknownDirect', async () => {
  ...
  test('direct-load-legacy_unknown', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-legacy_unknown', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOSTED_REST_TEST_LEGACY_UNKNOWN_ENTID']
