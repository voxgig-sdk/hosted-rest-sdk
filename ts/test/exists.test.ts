...
describe('exists', async () => {
  ...
  //
  // HostedRestSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof HostedRestSDK, true,
      'HostedRestSDK.test() must return a client synchronously')
  })
