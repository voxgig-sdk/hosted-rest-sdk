...
//     (\`new HostedRestSDK(...)\` / \`HostedRestSDK.test(...)\` become
//     \`HostedRestSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"agent_health":{"test01":{"id":"test01"}},"agent_sandbox":{"test01":{"id":"test01"}},"agent_user_detail":{"test01":{"id":"test01"}},"agent_user_list":{"test01":{"id":"test01"}},"app_user":{"test01":{"id":"test01"}},"app_user_login":{"test01":{"id":"test01"}},"app_user_session":{"test01":{"id":"test01"}},"app_user_total":{"test01":{"id":"test01"}},"app_user_verify":{"test01":{"id":"test01"}},"authentication":{"test01":{"id":"test01"}},"collection":{"test01":{"id":"test01"}},"collection_record":{"test01":{"id":"test01"}},"collection_record_list":{"test01":{"id":"test01"}},"custom":{"test01":{"id":"test01"}},"legacy":{"test01":{"id":"test01"}},"legacy_mutation":{"test01":{"id":"test01"}},"legacy_unknown":{"test01":{"id":"test01"}},"legacy_unknown_list":{"test01":{"id":"test01"}},"legacy_user":{"test01":{"id":"test01"}},"legacy_user_list":{"test01":{"id":"test01"}},"login":{"test01":{"id":"test01"}},"register":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new HostedRestSDK(...)\` and any
// \`HostedRestSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+HostedRestSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/HostedRestSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
