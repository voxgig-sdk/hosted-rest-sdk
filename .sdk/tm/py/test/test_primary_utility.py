...
from projectname_sdk import HostedRestSDK
from projectname_sdk.core.spec import HostedRestSpec
from projectname_sdk.core.result import HostedRestResult
from projectname_sdk.core.response import HostedRestResponse
from projectname_sdk.core.operation import HostedRestOperation
from projectname_sdk.core.error import HostedRestError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import HostedRestBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return HostedRestError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = HostedRestSDK.test(None, None)
        ...
        class TestInitFeature(HostedRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(HostedRestBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = HostedRestSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = HostedRestSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = HostedRestSDK.test(None, setup_opts)
