...
class HostedRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HostedRestTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = HostedRestTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = HostedRestTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
