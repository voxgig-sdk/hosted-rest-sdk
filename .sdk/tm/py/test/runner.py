...
class HostedRestTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HostedRestTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HostedRestTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HostedRestTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
