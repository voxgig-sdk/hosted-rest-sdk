...
class HostedRestCacheFeature extends HostedRestBaseFeature
{
    ...
    private function _through(HostedRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
