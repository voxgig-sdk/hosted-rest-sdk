...
// HostedRest SDK streaming feature
...
class HostedRestStreamingFeature extends HostedRestBaseFeature
{
    ...
    private function _iterate(HostedRestResult $result): \Generator
    {
    ...
    private function _streamable(HostedRestContext $ctx): bool
    {
