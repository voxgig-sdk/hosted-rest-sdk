...
// HostedRest SDK timeout feature
...
class HostedRestTimeoutFeature extends HostedRestBaseFeature
{
    ...
    private function _with_timeout(HostedRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HostedRestContext $_ctx, float $ms): void
    {
        $client = $this->client;
