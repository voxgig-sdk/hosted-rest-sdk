...
// HostedRest SDK telemetry feature
...
class HostedRestTelemetryFeature extends HostedRestBaseFeature
{
    ...
    private function _close(HostedRestContext $ctx, bool $ok): void
    {
