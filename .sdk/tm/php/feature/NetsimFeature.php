...
class HostedRestNetsimFeature extends HostedRestBaseFeature
{
    ...
    private function _simulate(HostedRestContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HostedRestContext $ctx, array $applied): void
    {
        $client = $this->client;
