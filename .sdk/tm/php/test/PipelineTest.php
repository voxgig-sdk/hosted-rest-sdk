...
{
    private static function utility(): HostedRestUtility
    {
        return new HostedRestUtility();
    }
    ...
    private static function ctx(array $over = []): HostedRestContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HostedRestContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HostedRestOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HostedRestError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HostedRestOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HostedRestMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HostedRestOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HostedRestMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HostedRestOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HostedRestMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HostedRestSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HostedRestMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HostedRestResponse([]),
            'result' => new HostedRestResult([]),
        ]);
        [, $err] = HostedRestMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HostedRestSpec([]),
            'response' => null,
            'result' => new HostedRestResult([]),
        ]);
        [, $err] = HostedRestMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HostedRestSpec(['step' => 's']),
            'response' => new HostedRestResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HostedRestResult([]),
        ]);
        [, $err] = HostedRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HostedRestSpec(['step' => 's']),
            'response' => new HostedRestResponse(self::resp(200, ['v' => 1])),
            'result' => new HostedRestResult([]),
        ]);
        [, $err] = HostedRestMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HostedRestSpec(['step' => 's']),
            'response' => new HostedRestResponse(self::resp(200, ['v' => 2])),
            'result' => new HostedRestResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HostedRestMakeResponse::call($ctx);
    ...
    {
        $preset = new HostedRestResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HostedRestSpec([]),
            'response' => new HostedRestResponse([]),
            'result' => new HostedRestResult([]),
        ...
        [$got, $err] = HostedRestMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HostedRestResult([])]);
        [, $err] = HostedRestMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HostedRestSpec([]), 'result' => null]);
        [, $err] = HostedRestMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HostedRestSpec(['step' => 's']),
            'result' => new HostedRestResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HostedRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HostedRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HostedRestSpec(['step' => 's']),
            'result' => new HostedRestResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HostedRestOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HostedRestMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HostedRestResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HostedRestSpec([]),
            'result' => new HostedRestResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HostedRestMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HostedRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HostedRestError('boom', 'boom');
        $utility->fetcher = function (HostedRestContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HostedRestSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HostedRestMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HostedRestContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HostedRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HostedRestResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HostedRestMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HostedRestContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HostedRestSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HostedRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HostedRestResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HostedRestSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HostedRestMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HostedRestMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HostedRestMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HostedRestResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HostedRestDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HostedRestResult(['ok' => false])]);
        $this->expectException(HostedRestError::class);
        HostedRestDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HostedRestResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HostedRestMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HostedRestMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HostedRestBaseFeature();
        $b = new HostedRestBaseFeature();
        HostedRestFeatureAdd::call($ctx, $a);
        HostedRestFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HostedRestBaseFeature
    {
        $f = new HostedRestBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HostedRestFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HostedRestContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HostedRestSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HostedRestPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HostedRestPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HostedRestResponse(['headers' => null]),
            'result' => new HostedRestResult([]),
        ]);
        HostedRestResultHeaders::call($ctx);
