...
// HostedRest SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HostedRestTransformResponse
{
    public static function call(HostedRestContext $ctx): mixed
    {
        ...
        $transform = HostedRestHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
