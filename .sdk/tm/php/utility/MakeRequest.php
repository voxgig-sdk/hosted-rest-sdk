...
// HostedRest SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HostedRestMakeRequest
{
    public static function call(HostedRestContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HostedRestResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HostedRestResponse($fetched);
        } else {
