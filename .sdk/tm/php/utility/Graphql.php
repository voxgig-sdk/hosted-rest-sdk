...
// HostedRest SDK utility: graphql
//
...
class HostedRestGraphql
{
    ...
    // equivalent.
    public static function body(HostedRestContext $ctx): mixed
    {
    ...
    public static function errors(HostedRestContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
