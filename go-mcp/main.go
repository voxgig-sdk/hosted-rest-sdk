// Command HostedRest-mcp is an MCP server exposing the HostedRest
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HostedRest_list  — list records of an entity
//	HostedRest_load  — load a single record of an entity
//
