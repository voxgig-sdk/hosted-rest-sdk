...
**Entities** (22): `AgentHealth`, `AgentSandbox`, `AgentUserDetail`, `AgentUserList`, `AppUser`, `AppUserLogin`, `AppUserSession`, `AppUserTotal`, `AppUserVerify`, `Authentication`, `Collection`, `CollectionRecord`, `CollectionRecordList`, `Custom`, `Legacy`, `LegacyMutation`, `LegacyUnknown`, `LegacyUnknownList`, `LegacyUser`, `LegacyUserList`, `Login`, `Register`.
